...
model_lvl <- c("pval", "stepaic", "bestsubset","lasso", "ncvreg", "mboost", "mars")
model_names <- c("P-value", "Step AIC", "Best subset", "Lasso", "MCP", "mboost", "MuARS")
...
f <- ggplot (df.plot) +
  ...
  scale_fill_manual(values = c("#030303", "#FF0000", "#000080", "#00EE00", "#8B3E2F", "#4A4A4A", "#A6A6A6")) +
  ylim (0,1) + 
  ylab ("Value") +
